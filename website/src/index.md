...
hero:
  name: Nom Nom
  text: Food delivery bible. 
  tagline: Find the cheapest prices for your food deliveries and pickups.
  image:
...
customMetaTitle: Nom Nom

features:
  - title: Compare Prices
    details: Find out which platform offers the best deal on deliveries and pickups for your favorite meals.
  ...
  - title: Restaurant Aggregation
    details: Instead of togglings the apps to see which platform is currently offering your restaurant, see it directly on Nom Nom.
  ...
  - title: Fast & Easy
    details: Compare prices with just a few clicks—no extra effort needed.
